...
ANALYSIS_CLASSES = [PublicPrivateInterface, MethodsLessThanFive, ClassesLessThanHundred, LazyPoltergeist, Inheritence, GlobalVariable, ExcessiveMethodParams, ObjectOrgy, MagicNumber]
